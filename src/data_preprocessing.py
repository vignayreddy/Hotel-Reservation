...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            logger.info("Dropping the unnecessary and duplicate  columns ")
            ...
            logger.error(f"Error during preprocess data...{e}")
            raise  CustomException("Error while preprocess data...",e)
        
    def balance_data(self,df):
        try:
            logger.info("Handling imbalanced datasets")
    ...
    def select_features(self,df):
        try:
            ...
            logger.info("Feature Selection complteted successfully...")

            return top_10_df
        except Exception as e:
            logger.error(f"Error during Feature   selection  step ... {e}")
            raise  CustomException("Error while Feature   selection of the  data...",e)
    ...
    def save_data(self,df,file_path):
        try:
            ...
            raise  CustomException("Error while saving data step ...",e)
